...
class Visualisierung:
    ...
    def plot_and_save(self, filename, file_format="png"):
        ...
        axs[1].yaxis.set_label_coords(-0.025, 0.5)
        ...
        axs[2].yaxis.set_label_coords(-0.025, 0.5)
        ...
        axs[4].yaxis.set_label_coords(-0.025, 0.5)
        ...
        axs[5].yaxis.set_label_coords(-0.025, 0.5)
