...
class Visualisierung:
    def __init__(self):
        ...
        self.T_Sol_ZUL = []
        self.T_WRG_ = []
        # Massenströme Erhitzer und Kühler
        self.m_ERH_ist = []
        self.m_KUL_ist = []
        # Luftvolumenstrom
        self.m_LUF = []
        # Masseströme Bypass-Filter (BFT) und Entfeuchter (ENF)
        self.m_BFT = []
        self.m_ENF = []
        # Zustand WRG (1 = ein, 0 = aus)
        self.WRG_state = []
        # Absolute Feuchten
        self.X_R = []
        self.X_Sol_R = []
    ...
    def add_data(self,
                 t,
                 T_R_soll, T_R, T_ZUL, T_Sol_ZUL, T_WRG_,
                 m_ERH, m_KUL,
                 m_LUF,
                 X_R, X_Sol_R, X_ZUL_Soll, X_ZUL,
                 m_BFT, m_ENF,
                 WRG_state):
        self.time.append(t)
    ...
    def plot(self):
        # 6 Subplots: [0]=Temp, [1]=m_ERH/m_KUL, [2]=Feuchte, [3]=m_LUF, [4]=m_BFT/m_ENF, [5]=WRG state
        ...
        axs[4].tick_params(axis='y', labelrotation=90)
        ...
        axs[5].set_ylabel("WRG\n(0=Aus,1=Ein)", fontsize=12, rotation=0)
        axs[5].yaxis.set_label_coords(-0.05, 0.5)
        axs[5].tick_params(axis='y', labelrotation=90)
